...
import 'package:first/screens/anotations_view.dart';
import 'package:first/screens/newTaskView.dart';
import 'package:first/screens/notePage.dart';
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              if (notesProvider.notes.isEmpty) {
                return const Center(
                    child:
                        Text('No hay notas', style: TextStyle(fontSize: 20)));
              } else {
        ...
        floatingActionButton: userProvider.user!.usertype == "paciente"
            ? Row(
                ...
                children: [
                  MouseRegion(
                    onEnter: (event) {
                      notesProvider.setNewTaskHover(true);
                    },
                    onExit: (event) {
                      notesProvider.setNewTaskHover(false);
                    },
                    child: InkWell(
                      ...
                      child: AnimatedContainer(
                          ...
                          child: notesProvider.newTaskHover
                              ? SvgPicture.asset(
                                  'lib/images/new_task_button.svg',
                                  fit: BoxFit.contain,
                                )
                              : SvgPicture.asset(
                                  'lib/images/new_task_hover_button.svg',
                                  fit: BoxFit.contain,
                                )),
                    ),
                  ),
